use crate::theme::{colors::SELECTED_BG, focused_border, label_text, normal_text, unfocused_border};
use ratatui::{
    style::Style,
    text::{Line, Span},
...
pub fn metadata_line_selectable<'a>(label: &'a str, value: impl Into<String>, selected: bool) -> Line<'a> {
    if selected {
        Line::from(vec![
