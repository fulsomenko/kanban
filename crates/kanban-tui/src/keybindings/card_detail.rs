    ...
    fn get_context(&self) -> KeybindingContext {
        ...
        KeybindingContext::new(
            ...
            vec![
                ...
                Keybinding::new("q", "quit", "Exit card detail view", KeybindingAction::Escape),
                Keybinding::new("ESC", "back", "Return to task list", KeybindingAction::Escape),
                Keybinding::new("1", "panel 1", "Focus task title panel", KeybindingAction::FocusPanel(0)),
                Keybinding::new("2", "panel 2", "Focus metadata panel", KeybindingAction::FocusPanel(1)),
                Keybinding::new("3", "panel 3", "Focus description panel", KeybindingAction::FocusPanel(2)),
                Keybinding::new("e", "edit", "Edit current panel", KeybindingAction::EditCard),
                Keybinding::new("d", "delete", "Delete this task", KeybindingAction::DeleteCard),
