    ...
    fn get_context(&self) -> KeybindingContext {
        KeybindingContext::new(
            ...
            vec![
                ...
                Keybinding::new("c", "complete", "Toggle task completion", KeybindingAction::ToggleCompletion),
                Keybinding::new("d", "archive", "Archive selected task(s)", KeybindingAction::ArchiveCard),
                Keybinding::new("D", "archived", "View archived tasks", KeybindingAction::ToggleArchivedView),
                ...
                Keybinding::new("h", "prev col", "Move to previous column", KeybindingAction::NavigateLeft),
                Keybinding::new("l", "next col", "Move to next column", KeybindingAction::NavigateRight),
                Keybinding::new("H", "move left", "Move card to left column", KeybindingAction::MoveCardLeft),
                Keybinding::new("L", "move right", "Move card to right column", KeybindingAction::MoveCardRight),
                ...
                Keybinding::new("a", "assign", "Assign task to sprint", KeybindingAction::AssignToSprint),
                Keybinding::new("t", "filter", "Toggle sprint filter", KeybindingAction::ToggleFilter),
                Keybinding::new("T", "options", "Open filter options", KeybindingAction::ToggleHideAssigned),
                Keybinding::new("/", "search", "Search tasks", KeybindingAction::Search),
                Keybinding::new("Enter/Space", "detail", "View task detail", KeybindingAction::SelectItem),
                Keybinding::new("p", "priority", "Set task priority", KeybindingAction::EditCard),
            ],
        )
    }
}
